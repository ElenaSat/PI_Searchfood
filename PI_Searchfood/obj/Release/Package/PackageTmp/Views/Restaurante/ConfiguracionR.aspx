<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/Template/Restaurantes.Master" AutoEventWireup="true" CodeBehind="ConfiguracionR.aspx.cs" Inherits="PI_Searchfood.Views.Restaurante.ConfiguracionR" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Contenido" runat="server">
    
    <div class="card mx-auto mt-5">
        <div class="card-header">
            Configuración Cuenta Restaurante  
        </div>
        <div class="card-body">
